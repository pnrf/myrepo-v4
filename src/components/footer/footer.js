  ...
  return (
		<div className={styles['footer__container']}>
			<div>
				...
				<p className={styles['footer__text']}>Изображение со <a href="https://storyset.com/illustration/researching/bro#647F94FF&hide=&hide=simple" target="_blank">Storyset by Freepik</a></p>
