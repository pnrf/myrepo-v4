  ...
  return (
		<div className={styles['footer__container']}>
			<div>
				...
				<p className={styles['footer__text']}>Изображение на главной странице со <a href="https://storyset.com/illustration/researching/bro#647F94FF&hide=&hide=simple" target="_blank">Storyset by Freepik</a></p>
				<p className={`${styles['footer__text']} ${styles['footer__text-margins']}`}>Контент составлен при помощи <a href="https://ya.ru/ai/art" target="_blank">YandexART</a> и <a href="https://ya.ru/ai/gpt" target="_blank">YandexGPT</a></p>
