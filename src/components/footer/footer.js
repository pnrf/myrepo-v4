  ...
  return (
		<div className={styles['footer__container']}>
			<div>
				...
				<p className={`${styles['footer__text']} ${styles['footer__text-margins']}`}>Контент составлен с помощью <a href="https://ya.ru/ai/art" target="_blank">YandexART</a> и <a href="https://ya.ru/ai/gpt" target="_blank">YandexGPT</a></p>
