				...
				<div className={styles['hero-section__container']}>
					<div className={styles['hero-section__text-wrapper']}>
						...
						<div className={styles['hero-section__text-block']}>
							<p className={styles['hero-section__text']}>Работаю в ИТ с 2023 г. В <a className={styles['hero-section__link']} href="https://www.hse.ru/staff/pankratov" target="_blank">НИУ ВШЭ</a> с 2025 г.</p>
