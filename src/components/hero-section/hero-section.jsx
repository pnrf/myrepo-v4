		...
		<section className={styles['hero-section']}>
			<div className={styles['hero-section__content']}>
				<div className={styles['hero-section__text-wrapper']}>
					...
					<p className={styles['hero-section__text']}>Сделал этот сайт для поиска работы, чтобы общаться с рекрутерами на реальных примерах. Это экономит время и повышает шансы на успех.</p>
				</div>
