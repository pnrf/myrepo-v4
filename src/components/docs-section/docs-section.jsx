				...
				<div className={styles['portfolio-section__card']}>
					...
					<div className={styles['portfolio-section__card-content']}>
						<ul className={styles['portfolio-section__card-list']}>
							...
							<br /> */}
							<li className={styles['portfolio-section__card-list-item']}><a className={styles['portfolio-section__link']} href='#' target="_blank">Лицензионный договор ↗</a></li>
							<li className={styles['portfolio-section__card-list-item']}><a className={styles['portfolio-section__link']} href='#' target="_blank">Правила внутреннего распорядка ↗</a></li>
							<li className={styles['portfolio-section__card-list-item']}><a className={styles['portfolio-section__link']} href='#' target="_blank">Положение об отделе ↗</a></li>
						</ul>
