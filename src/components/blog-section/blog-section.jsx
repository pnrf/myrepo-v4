...
export default function BlogSection() {
  return (
		<section className={styles['blog-section']}>
			<h2 className={styles['blog-section__heading']}>Статьи и заметки</h2>
			<div className={styles['blog-section__container']}>
				<div className={styles['blog-section__card']}>
					<ul className={styles['blog-section__card-list']}>
						...
						<li className={styles['blog-section__card-list-item']}><a className={styles['blog-section__link']} href='/blog/articles/kak-sdelat-sayt-s-tekhnicheskoy-dokumentatsiyey'>Как сделать сайт с документацией</a><span className={styles['blog-section__card-list-item-date']}> – Апрель 10, 2025</span></li>
