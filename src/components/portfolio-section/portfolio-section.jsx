			...
			<div className={styles['portfolio-section__container']}>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/docs-on-demand'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Оптимизация процесса заказной разработки технической и юридической документации</p>
					</a>
				</article>
				...
				<article className={`${styles['portfolio-section__card']} ${styles['portfolio-section__card_highlight']}`}>
					<a href='/portfolio/docs-as-code'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Изучение технологий для автоматизации процесса документирования</p>
					</a>
				</article>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/ui-components'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Разработка и тестирование UI-компонентов в сервисе Storybook</p>
					</a>
				</article>
				...
				<article className={`${styles['portfolio-section__card']} ${styles['portfolio-section__card_highlight']}`}>
					<a href='/portfolio/portfolio-website/about-project'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Разработка сайта-портфолио технического писателя с базой знаний и блогом</p>
					</a>
				</article>
				...
				<article className={`${styles['portfolio-section__card']} ${styles['portfolio-section__card_highlight']}`}>
					<a href='/portfolio/second-brain'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Разработка домашней базы знаний в Obsidian. Применяю концепции Second Brain и P.A.R.A.</p>
					</a>
				</article>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/book-of-stories'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Оформление сборника историй технических писателей "Как войти в профессию"</p>
					</a>
				</article>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/movies-explorer/about-project'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Разработка веб-приложения с личным кабинетом. Дипломный проект в Я.Практикуме</p>
					</a>
				</article>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/draft-laws'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Участие в качестве гражданского эксперта в разработке законопроектов</p>
					</a>
				</article>
				...
				<article className={styles['portfolio-section__card']}>
					<a href='/portfolio/legal-practice'>
						...
						<p className={styles['portfolio-section__card-list-item']}>Ведение частной юридической практики. Офис в Москва-Сити</p>
					</a>
				</article>
			</div>
		</section>
